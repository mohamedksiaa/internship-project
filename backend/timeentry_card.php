...
if (($id || $ref) && $action == 'edit') {
	print load_fiche_titre($langs->trans("TimeEntry"), '', $object->picto);
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
	...
	print dol_get_fiche_head($head, 'card', $langs->trans("TimeEntry"), -1, $object->picto, 0, '', '', 0, '', 1);
	...
	*/
	...
	if ($action != 'presend') {
		...
		$tmparray = $form->showLinkToObjectBlock($object, array(), array('timeentry'), 1);
