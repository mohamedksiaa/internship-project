...
$title = $langs->trans("TimeEntrys");
//$help_url = "EN:Module_TimeEntry|FR:Module_TimeEntry_FR|ES:Módulo_TimeEntry";
$help_url = '';
$morejs = array();
$morecss = array();
...
$topicmail = "SendTimeEntryRef";
$modelmail = "timeentry";
$objecttmp = new TimeEntry($db);
