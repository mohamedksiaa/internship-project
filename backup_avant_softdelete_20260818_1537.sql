...
(344,'MAIN_MODULE_TIMEFLOW',1,'1','string',0,'{\"authorid\":\"1\",\"ip\":\"::1\",\"lastactivationversion\":\"1.0\"}','2026-08-18 12:53:21'),
(345,'MAIN_MODULE_TIMEFLOW_TRIGGERS',1,'1','chaine',0,NULL,'2026-08-18 12:53:21'),
(346,'MAIN_MODULE_TIMEFLOW_ICON',1,'fa-file','chaine',0,NULL,'2026-08-18 12:53:21');
...
(57,'all',1,'timeflow','top','timeflow',NULL,0,NULL,NULL,1001,'/timeflow/timeflowindex.php','','ModuleTimeFlowName','<span class=\"fas fa-file pictofixedwidth valignmiddle\" style=\"\"></span>','timeflow@timeflow',NULL,'1','isModEnabled(\'timeflow\')',2,'2026-08-18 12:53:21',0);
...
(50000001,1,'Read TimeEntry object of TimeFlow','timeflow','',100090,'other',0,'timeentry','read','w',0,'1'),
(50000002,1,'Read all TimeEntry objects (all users) of TimeFlow','timeflow','',100090,'other',0,'timeentry','readall','w',0,'1'),
(50000003,1,'Create/Update TimeEntry object of TimeFlow','timeflow','',100090,'other',0,'timeentry','write','w',0,'1'),
(50000004,1,'Validate TimeEntry of TimeFlow','timeflow','',100090,'other',0,'timeentry','validate','w',0,'1'),
(50000005,1,'Delete TimeEntry object of TimeFlow','timeflow','',100090,'other',0,'timeentry','delete','w',0,'1'),
(50000006,1,'Valider les entrées de temps','timeflow','',100090,'other',0,'valider','','w',0,'1'),
...
INSERT INTO `llx_timeflow_daily_report` VALUES
...
INSERT INTO `llx_timeflow_project` VALUES
...
INSERT INTO `llx_timeflow_project_text` VALUES
...
(18,1,31,'a','azerty',1,'2026-08-18 10:50:02','2026-08-18 10:50:02',NULL),
(19,1,32,'vbff','my own',1,'2026-08-18 13:24:30','2026-08-18 13:24:30',NULL);
...
INSERT INTO `llx_timeflow_task` VALUES
...
(19,1,1,31,'azerty','azerty',1,'2026-08-18 10:50:02','2026-08-18 10:50:02',NULL),
(20,1,1,32,'my own','my own',1,'2026-08-18 13:24:30','2026-08-18 13:24:30',NULL);
...
INSERT INTO `llx_timeflow_time_edit_log` VALUES
...
INSERT INTO `llx_timeflow_timeentry` VALUES
...
(32,1,1,3,NULL,'2026-08-18 13:24:30','2026-08-18 13:24:32',2,0,1,NULL,'my own','',0,0.00000000,0.00000000,NULL,NULL,2,'2026-08-18 13:24:33',1,1,'2026-08-18 13:24:30','2026-08-18 13:24:30',1,1,NULL);
...
CREATE TABLE `llx_timeflow_timeentry_modification` (
  ...
  `fk_user_creat` int(11) NOT NULL,
  PRIMARY KEY (`rowid`),
  KEY `idx_timeflow_timeentry_modification_timeentry` (`fk_timeentry`),
  KEY `idx_timeflow_timeentry_modification_user` (`fk_user`),
  KEY `idx_timeflow_timeentry_modification_action` (`action`),
  KEY `idx_timeflow_timeentry_modification_date` (`date_creation`),
...
INSERT INTO `llx_timeflow_timeentry_modification` VALUES
...
(8,0,31,1,'delete','_entry','31','','Suppression de l’entrée de temps','2026-08-18 13:24:20',1);
...
-- Dump completed on 2026-08-18 15:37:35
