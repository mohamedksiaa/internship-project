...
/**
 * \file    core/triggers/interface_99_modTimeFlow_TimeFlowTriggers.class.php
 * \ingroup timeflow
 * \brief   Example of trigger file.
 *
 * You can create other triggered files by copying this one.
 * - File name should be either:
 *      - interface_99_modTimeFlow_MyTrigger.class.php
...
/**
 *  Class of triggers for TimeFlow module
 */
class InterfaceTimeFlowTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
