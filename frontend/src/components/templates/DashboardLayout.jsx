  ...
  return (
    <div className="mx-auto max-w-[1680px] p-5 lg:p-7">
      ...
      <div className="mb-4 grid gap-4 md:grid-cols-3">
        <Card headerLabel={t('dashboard.total_week')} className="text-center" headerRight={canReadAll ? <span title={t('dashboard.team_total_tooltip')} className="text-xs text-[#71838f]">ℹ︎</span> : null}>
