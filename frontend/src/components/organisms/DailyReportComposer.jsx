...
// Deletion is offered for Brouillon (0, subject to the 24h draft-expiry
// window), Soumis (1), and Refusé (9), subject to the server-provided
// delete_allowed permission. A Validé (2) report remains protected here.
