...
vi.mock('../../api/clockifyApi', () => ({
  getModificationHistory: vi.fn().mockResolvedValue([
    { rowid: 7, fk_user: 5, user_label: 'Emma Lambert', field_name: 'date_end', old_value: '2026-08-12 14:24:00', new_value: '2026-08-12 15:03:00', reason: 'aaaaaaaa', date_creation: '2026-08-12 15:25:00' },
  ]),
}));
